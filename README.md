...
Sou um desenvolvedor focado em criar soluções eficientes por meio da programação e da análise de dados. Desenvolvo automações, sistemas web e ferramentas que transformam dados brutos em decisões inteligentes. Estou em constante evolução, aplicando novas tecnologias em projetos práticos para entregar inovação e alto valor técnico.
